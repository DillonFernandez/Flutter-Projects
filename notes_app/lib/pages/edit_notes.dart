...
// EditNotePage StatefulWidget for editing an existing note
...
class _EditNotePageState extends State<EditNotePage> {
  ...
  // Updates the note in Firebase Realtime Database
  Future<void> _updateNote() async {
    ...
    final DatabaseReference noteRef = FirebaseDatabase.instance.ref(
      'users/${user.uid}/notes/${widget.noteKey}',
    );
  ...
  // Builds the UI for the Edit Note page
  @override
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 24),
                      // Update Note button with loading indicator
                      SizedBox(
